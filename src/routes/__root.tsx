...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Gipsm Technology" },
      { name: "theme-color", content: "#0a0a0f" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Gipsm Technology" },
      { name: "twitter:card", content: "summary_large_image" },
      { title: "Gipsm Technology | Digital Growth Agency" },
      { property: "og:title", content: "Gipsm Technology | Digital Growth Agency" },
      { name: "twitter:title", content: "Gipsm Technology | Digital Growth Agency" },
      { name: "description", content: "Gipsm Technology helps businesses grow with strategy, branding, websites, digital marketing, automation, and performance-focused digital execution." },
      { property: "og:description", content: "Gipsm Technology helps businesses grow with strategy, branding, websites, digital marketing, automation, and performance-focused digital execution." },
      { name: "twitter:description", content: "Gipsm Technology helps businesses grow with strategy, branding, websites, digital marketing, automation, and performance-focused digital execution." },
