...
export const Route = createFileRoute("/terms-of-service")({
  head: () => ({
    meta: [
      ...
      { property: "og:image:alt", content: "NexaStudio Terms of Service — The terms that govern use of our website and services." },
      { name: "twitter:title", content: TITLE },
      { name: "twitter:description", content: DESCRIPTION },
      { name: "twitter:image", content: "/og/terms-of-service.jpg" },
      { name: "twitter:image:alt", content: "NexaStudio Terms of Service — The terms that govern use of our website and services." },
    ],
