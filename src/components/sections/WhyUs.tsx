...
const STATS = [
  { icon: Clock, n: 8, suffix: "+", label: "Years in business" },
  { icon: Users, n: 200, suffix: "+", label: "Happy clients" },
  { icon: Award, n: 50, suffix: "+", label: "Industry awards" },
  { icon: Headphones, n: 24, suffix: "/7", label: "Partner support" },
];
  ...
  return (
    <section className="relative py-32">
      <div className="mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-16 items-center">
        <Reveal>
          <p className="text-xs uppercase tracking-[0.25em] text-primary mb-4">— Why NexaStudio</p>
