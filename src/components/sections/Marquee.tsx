const CAPABILITIES = ["Strategy", "Brand", "Web", "Product", "Content", "SEO", "Automation", "Performance", "Analytics", "Growth"];

export function Marquee() {
  return (
    <section aria-label="Capabilities" className="py-16 border-y border-border overflow-hidden">
      ...
      <div className="marquee-mask">
        <div className="flex w-max animate-marquee gap-16 pr-16">
          {[...CAPABILITIES, ...CAPABILITIES].map((b, i) => (
